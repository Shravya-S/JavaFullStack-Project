...
<li ><a href="View.jsp" id="ii">View Data</a></li>
</ul></div>
<%
...
<form action="vw" method="post">

<h2> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspView Data</h2><br><br>

<br><br>
<input type="text" placeholder=" Account Number" name="acc" id="clr"><br><br>

<input type="submit" value="Get" id="ch">
</form>
